class Validator {
	...
	validate(e) {
		...
		if(elFields[fieldName].required) {
			if(fieldValue === '') {
				this.errors[fieldName].push('Empty input!');
			}
		}
		...
		if(fieldValue.length < elFields[fieldName].minlength || fieldValue.length > elFields[fieldName].maxlength) {
			this.errors[fieldName].push(`Field lenght is minimum ${elFields[fieldName].minlength} and maximum ${elFields[fieldName].maxlength} characters`);
		}
		...
		if(elFields[fieldName].matching) {
			...
			if(fieldValue !== matchingEl.value) {
				this.errors[fieldName].push('Password not match!');
			}
